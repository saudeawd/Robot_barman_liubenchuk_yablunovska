...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FtIdenLoad-request>)))
  ...
  (cl:format cl:nil "# This format is suitable for the following services~%#   - iden_ft_sensor_load_offset     # The old name is ft_sensor_iden_load, please use the new one~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FtIdenLoad-request)))
  "Returns full string definition for message of type 'FtIdenLoad-request"
  (cl:format cl:nil "# This format is suitable for the following services~%#   - iden_ft_sensor_load_offset     # The old name is ft_sensor_iden_load, please use the new one~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FtIdenLoad-response>)))
  ...
  (cl:format cl:nil "~%int16 ret~%string message~%~%# the result of identification~%#   iden_ft_sensor_load_offset: [mass(kg)，x_centroid(mm)，y_centroid(mm)，z_centroid(mm)，Fx_offset，Fy_offset，Fz_offset，Tx_offset，Ty_offset，Tz_ffset]~%float32[] datas~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FtIdenLoad-response)))
  "Returns full string definition for message of type 'FtIdenLoad-response"
  (cl:format cl:nil "~%int16 ret~%string message~%~%# the result of identification~%#   iden_ft_sensor_load_offset: [mass(kg)，x_centroid(mm)，y_centroid(mm)，z_centroid(mm)，Fx_offset，Fy_offset，Fz_offset，Tx_offset，Ty_offset，Tz_ffset]~%float32[] datas~%~%~%"))
