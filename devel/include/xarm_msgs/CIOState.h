...
struct Printer< ::xarm_msgs::CIOState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::xarm_msgs::CIOState_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "input_digitals: ";
    if (v.input_digitals.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.input_digitals.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint16_t>::stream(s, true ? std::string() : indent + "    ", v.input_digitals[i]);
    }
    if (v.input_digitals.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "output_digitals: ";
    if (v.output_digitals.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.output_digitals.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint16_t>::stream(s, true ? std::string() : indent + "    ", v.output_digitals[i]);
    }
    if (v.output_digitals.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "input_analogs: ";
    if (v.input_analogs.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.input_analogs.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<float>::stream(s, true ? std::string() : indent + "    ", v.input_analogs[i]);
    }
    if (v.input_analogs.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "output_analogs: ";
    if (v.output_analogs.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.output_analogs.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<float>::stream(s, true ? std::string() : indent + "    ", v.output_analogs[i]);
    }
    if (v.output_analogs.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.input_conf.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.input_conf[i]);
    }
    if (v.input_conf.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "output_conf: ";
    if (v.output_conf.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.output_conf.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.output_conf[i]);
    }
    if (v.output_conf.empty() || true)
      s << "]";
  }
